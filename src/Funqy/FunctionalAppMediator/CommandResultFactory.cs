namespace FunctionalPipeline
{
    public class CommandResultFactory
    {
        ...
        /// </summary>
        /// <param name="message">Optional message that is saved to the Message property on the <see cref="CommandResult"/></param>
        ...
        /// <param name="message">Optional message that is saved to the Message property on the <see cref="CommandResult{T}"/></param>
        ...
        {
            return commandResultResult == null ? new CommandResult<T>(default(T), false, message) : new CommandResult<T>(commandResultResult.Value, false, message);
        }
    }
}
